...
<xsl:stylesheet version="1.0"
	...
	<xsl:template match="/doc:metadata/doc:element[@name='dc']/doc:element[@name='type']/doc:element/doc:field/text()">
		<xsl:choose>
			...
			<xsl:when test="contains(., 'bookpart')">
            ...
            <xsl:when test="contains(., 'workingpaper')">
