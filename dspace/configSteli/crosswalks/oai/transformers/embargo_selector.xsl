...
<!-- added steli to test-->
<xsl:variable name="todayDateTime" select="current-date()"/>
<xsl:variable name="today" select="translate(todayDateTime, '-', '')"/>
...
-->
		<xsl:variable name="todayDateTime" select="current-date()"/>
<xsl:variable name="todayDateTimeFormated" select="format-date($todayDateTime, '[Y0001]-[M01]-[D01]')"/>
		<xsl:variable name="today" select="translate($todayDateTimeFormated, '-', '')"/>
